...
const MoneyFlowChart = dynamic(
  ...
  { ssr: false, loading: () => <div className="h-[280px] w-full mt-4 bg-gray-100 rounded-xl animate-pulse" /> }
);

const SpendingCategoryChart = dynamic(
  () => import("@/frontend/components/budget-donut-chart").then((m) => m.SpendingCategoryChart),
  { ssr: false, loading: () => <div className="h-[220px] w-full bg-gray-100 rounded-xl animate-pulse" /> }
);
